          ...
          <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control form-control-border" id="birthdate" name="birthdate" placeholder="Birth Date" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="form-control form-control-border" id="upload_identity" name="upload_identity" accept="image/*" required>
                </div>
               <div class="form-group">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <input type="submit" class="btn elevation-1 btn-sm btn-primary " id="add-patient_btn" name="add-patient" value="Save">
            </div>
          </div>
            </form>
          <!-- /.modal-content -->
...
$(document).ready(function(){
    ...
    function checkNumber() {
        ...
        if (contact > 09999999999) {
            ...
            document.getElementById("add-patient_btn").disabled = true;
            ...
            document.getElementById("add-patient_btn").disabled = false;
