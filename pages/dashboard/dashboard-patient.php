        ...
        <div class="row">
          <div class="col-lg-4 col-12">
            ...
            <div class="small-box bg-info">
              ...
              <a href="../clinic/clinic-patient.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
            ...
            <div class="small-box bg-warning">
              ...
              <a href="../services/services-patient.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
            ...
            <div class="small-box bg-orange">
              <div class="inner">
                <?php
                  require_once '../database&config/config.php';
                  $cn = new mysqli (HOST, USER, PW, DB);
                  $sql="SELECT COUNT(service_id) FROM tbl_services";
                  $qry=$cn->prepare($sql);
                  $qry->execute();
                  $qry->bind_result($no_services);
                  $qry->store_result();
                  $qry->fetch();
                  echo "<h3>$no_services</h3>";
                  ?>
