<div class='modal fade' id='delete-reservation-<?php echo $appointment_id; ?>'>
        <div class="modal-dialog modal-md">
          ...
          <div class="modal-content ">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <input type="submit" class="btn elevation-1 btn-sm btn-danger" name="delete-reservation" value="Delete">
            </div>
          </div>
            </form>
          <!-- /.modal-content -->
