...
<!--            <iframe src="index.php" style="height:500px;width:100%;"></iframe>-->
            <div id="qr-reader" style="width:400px;display: block;margin-left: auto;margin-right: auto;"></div>
            <div id="qr-reader-results"></div>
    
            <form method="get" action="../consultation/consultation-history-patient.php" hidden>
