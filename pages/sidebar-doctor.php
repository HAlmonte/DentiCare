<nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
            <a href="../dashboard/dashboard-doctor.php" class="nav-link">
        ...
        <li class="nav-item">
            <a href="../clinic/my-clinic.php" class="nav-link">
        ...
        <li class="nav-item">
            <a href="../clinic-schedule/clinic-schedule.php" class="nav-link">
                <i class="nav-icon fa  ion-android-time"></i>
                <p>
                    Clinic Schedule
                </p>
            </a>
        ...
        <li class="nav-item">
            <a href="../consultation/consultation-history.php" class="nav-link">
        ...
        <li class="nav-item">
            <a href="../qr-code/scan-qr-code.php" class="nav-link">
