  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card col-md-8 mx-auto">
          ...
          $sql="SELECT user_id, last_name, first_name, middle_name, contact, email, address, username, password, avatar, account_status FROM tbl_user WHERE user_id = ?";
          $qry=$cn->prepare($sql);
          $qry->bind_param("s", $user_id);
          $qry->execute();
          $qry->bind_result($user_id, $last_name, $first_name, $middle_name, $contact, $email, $address, $username, $password, $avatar, $account_status);
          $qry->store_result();
          $qry->fetch();
          ?>
          <form method="post" class="form-horizontal">
              <div class="card-body">
                  <div class="text-center">                      
                      <ul class="list-group list-group-unbordered mb-3">
                          <li class="list-group-item">
                              <img class="img-circle elevation-2" style="height:200px;" src="../uploads/<?php echo $avatar; ?>" alt="User profile picture"><br>
                          </li>
                          <li class="list-group-item">
                              <button type="button" class='btn btn-sm elevation-1 btn-warning btn-xs' data-toggle='modal' data-target='#edit-avatar-<?php echo $user_id;?>'><i class='nav-icon fas fa-pen'></i> Edit Picture</button>
                          </li>
                      </ul>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                      ...
                      <button type="button" class='form-control btn btn-sm elevation-1 btn-default btn-sm' data-toggle='modal' data-target='#edit-password-<?php echo $user_id;?>'>Change Password</button>
                  </div>
              </div>
              <div class="card-footer">
                  ...
                  <input type="submit" class="btn btn-primary btn-sm elevation-1" name="edit-user" value="Save">
            </div>
          </form>
        <!-- /.card-body -->
      </div>
...
<?php include '../header&footer/scripts.php'; include 'edit-avatar-modal.php'; include 'edit-password-modal.php';?>
<script>
$(function () {
      $("#example1").DataTable({
