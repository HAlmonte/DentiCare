          ...
          <div class="modal-content">
            <div class="modal-body">                
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="form-control form-control-border" id="avatar" name="avatar" placeholder="Profile Picture" accept="image/*" required>
                </div>
                <div class="form-group">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <input type="submit" class="btn btn-primary btn-sm elevation-1" name="add-user" id="add-user_btn" value="Save">
            </div>
          </div>
            </form>
          <!-- /.modal-content -->
...
<script>
    //File Validation
var uploadField2 = document.getElementById("avatar");
